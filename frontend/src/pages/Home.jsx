  ...
  return (
    <Box sx={{ minHeight: '100vh', bgcolor: 'white', display: 'flex', flexDirection: 'column' }}>
      ...
      <Container component="main" sx={{ flex: 1, py: 6, textAlign: 'center' }}>
        ...
        <Typography variant="subtitle1" color="textSecondary" sx={{ mb: 4, maxWidth: 600, mx: 'auto'}}>
          Get accurate solutions to any math problem in seconds, powered by advanced AI. Simple, fast, and reliable.
        </Typography>
        ...
        >
          <Grid container spacing={2} justifyContent="center">
            ...
            {[
              ['If 3x+5=17, what is the value of x?', 'How many milliseconds are there in 5.5 days?'],
              ['Change 5 horsepower to watts (1 hp = 745.7 W)', 'Convert 72 km/h to m/s'],
            ].map((pair, rowIndex) => (
              <Grid item xs={12} sm={6} md={6} key={rowIndex} container spacing={2} justifyContent="center">
      ...
      left: 1098, }}>
                    <img src="/assets/download__4_-removebg-preview.png" alt="Icon" width={24} height={24} />
                  </Box>
                  <Typography variant="body2" sx={{
                          fontFamily: '"Outfit", sans-serif', // Apply Outfit font
                          fontWeight: 'light', // Light font weight
